...
class DomTypeObjectProperty extends ReactComponentExtend {
    constructor() {
        super(...arguments);
    ...
    render() {
        ...
        ;
        let customProperty = this.props.property.dataProperty;
        let propsBtn = {
...
(function (DomTypeObjectProperty) {
    class Args {
    ...
    DomTypeObjectProperty.Args = Args;
})(DomTypeObjectProperty || (DomTypeObjectProperty = {}));
export default DomTypeObjectProperty;
