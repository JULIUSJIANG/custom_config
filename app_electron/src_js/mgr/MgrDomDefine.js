...
(function (MgrDomDefine) {
    ...
    MgrDomDefine.STYLE_COLOR_BLACK = "black";
    //【其他的属性名】
    ...
    MgrDomDefine.PROPS_SIZE = "size";
    MgrDomDefine.PROPS_SIZE_SMALL = "small";
    //【样式中各元素需要统一的值放这里】
    /**
     * 外边距 - 数字形式
     */
     ...
     * 事件名 - 拖拽 - 开始
     */
    MgrDomDefine.EVT_NAME_DRAG_START = `dragstart`;
    /**
     * 事件名 - 拖拽 - 中
     */
    MgrDomDefine.EVT_NAME_DRAG_ING = `drag`;
    /**
     * 事件名 - 拖拽 - 结束
     */
    MgrDomDefine.EVT_NAME_DRAG_END = `dragend`;
    /**
     * 事件名 - 拖拽 - 进入
     */
    MgrDomDefine.EVT_NAME_DRAG_ENTER = `dragenter`;
    /**
     * 事件名 - 拖拽 - 悬浮
     */
    MgrDomDefine.EVT_NAME_DRAG_OVER = `dragover`;
    /**
     * 事件名 - 拖拽 - 离开
     */
    MgrDomDefine.EVT_NAME_DRAG_LEAVE = `dragleave`;
